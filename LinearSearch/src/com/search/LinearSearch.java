...
public class LinearSearch {
    ...
    public static int linearSearchBounded(int[] arr, int target, int start, int end) {
        if (arr.length == 0) {
            return -1;
        }
    ...
    public static void main(String[] args) {
        ...
        index = linearSearchBounded(arr, 555, 1, 5);
        System.out.println("Bounded search result : " + index);
    }
}